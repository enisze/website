...
export function ProjectShowcase(project: Project) {
	console.log(project.title, project.images[0].src)
	return (
		<div className='w-full max-w-7xl mx-auto'>
			<div className='relative group bg-gradient-to-br from-zinc-50 to-zinc-100 dark:from-zinc-900 dark:to-zinc-800 rounded-3xl overflow-hidden p-1'>
				...
				<div className='relative bg-white dark:bg-zinc-950 rounded-[calc(1.5rem-4px)] overflow-hidden p-8 md:p-12'>
