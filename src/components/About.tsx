export const About = () => (
	<div className='text-xl animate-fade'>
		...
		<br />
		<br />I studied computer science at RWTH Aachen, focusing on machine
		learning, AI, and data science with Python. My theses involved generative
		...
		<br />
		<br />I have strong leadership skills and thrive in team environments,
		believing that effective communication and adaptability are key to
